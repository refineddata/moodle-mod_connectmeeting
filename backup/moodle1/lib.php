 ...
 */
class moodle1_mod_connectmeeting_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            ...
            new convert_path('connect_grades', '/MOODLE_BACKUP/COURSE/MODULES/MOD/CONNECTMEETING/GRADING'),
            new convert_path('connect_grade', '/MOODLE_BACKUP/COURSE/MODULES/MOD/CONNECTMEETING/GRADING/GRADE'),
        );
    }
