<?php
$string['modulenameplural']     = 'Connect Meetings';
$string['modulename']           = 'Connect Meeting';
$string['modulename_help']      = 'Create live events, meetings and trainings in Adobe Connect directly from the LMS course page. This includes the ability to add new meetings or reuse existing meeting rooms. Meetings, individual instances or multiple instances (recurring), can be set up days, weeks and months in advance. Linking the event to the course calendar allows for <a target="_blank" href="http://support.refineddata.com/hc/en-us/sections/200433400-Refined-Reminder-System">Refined Reminders</a> to be issued with direct-access links to the meeting sent via email at selected times. Not only can you upload presentations and slides to the meeting in advance, you can record the session for viewing later with access directly from the course page. 
    Enable Adobe Grading and the LMS will pull grading details from Adobe Connect. If using <a target="_blank" href="http://www.refineddata.com/vantagepoint/">Vantage Point</a> in your meeting, enable Vantage Point Interaction grading for a percentage grade based on the number of challenges answered. Report on meeting attendance and duration, access Vantage Point session reports and view how polls were answered from within the meeting. 
    Certificates can be issued after meeting completion as well as the option to un-enroll learners based on attendance.<br /><br />
A personalized list of upcoming meetings can be displayed for each user with the  <a target="_blank" href="http://support.refineddata.com/hc/en-us/articles/202238510#My_Meetings">My Meetings tag</a> and a personalized list of all recordings that the user has permissions to view via the <a target="_blank" href="http://support.refineddata.com/hc/en-us/articles/202026164-My-Recordings">My Recordings Block feature</a>.<br /><br />
 <a target="_blank" href="http://support.refineddata.com/hc/en-us/articles/202354664-Connect-Meetings">More information about Connect Meetings</a>.';
$string['pluginname']           = 'Connect Meeting';
...
$string['connectmeeting:host']      = 'Connect Host';
$string['connectmeeting:presenter'] = 'Connect Presenter';
...
$string['connectmeetingcron']            = 'Mod Connect Meeting Cron';
...
$string['connectmeeting:addinstance']   = 'Add connect meeting activity';
