...
$PAGE->set_url('/mod/connectmeeting/regrade.php');
...
if (isset($id) AND $id) $sql = "SELECT * from {$CFG->prefix}connectmeeting WHERE course = $id";
else $sql = "SELECT * from {$CFG->prefix}connectmeeting WHERE start > $start AND start < $end AND type = 'meeting'";
